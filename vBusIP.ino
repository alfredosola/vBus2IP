//    vBusIP, by Alfredo Sola, a sketch for Arduino to access vBus data over IP
//    Copyright (C) 2017 Alfredo Sola. See README.md for full credits.
...
// Author can be contacted by Twitter: @alfredosola
